    ...
    <div class="input-group mb-2" id="couponField">
      ...
      <!-- <a type="submit" onclick="applyInsCoupon()" class="btn theme-btn">Apply Code</a>       -->
            ...
            <ul class="generic-list-item pb-3">
                <li><i class="la la-play-circle-o mr-2 text-color"></i>{{ $course->duration }} hours</li>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-3">
                <div class="cta-btn-box text-right">
                    <a href="become-a-teacher.html" class="btn theme-btn">Teach on Santutor <i class="la la-arrow-right icon ml-1"></i> </a>
                </div>
            </div><!-- end col-lg-3 -->
        </div><!-- end row -->
    </div><!-- end container -->
