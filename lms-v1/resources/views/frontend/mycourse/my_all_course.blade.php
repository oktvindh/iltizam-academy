...
<div class="container-fluid">
    ...
    <div class="dashboard-heading mb-5">
        ...
        <div class="more-btn-box mt-4">
            <a href="{{ route('course.grid') }}" class="btn theme-btn">Add Courses </a>
        </div>
    </div>
       ...
       @foreach ($mycourse as $item)
        ...
        <div class="card card-item card-item-list-layout">
            ...
            <div class="card-body">
                ...
                <!-- <h5 class="card-title"><a href="{{ route('course.view',$item->course_id) }}">{{ $item->course_name }}</a></h5> -->
                <h5 class="card-title"><a href="#">{{ $item->course_name }}</a></h5>
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <p class="card-price text-black font-weight-bold">Rp.{{ $item->selling_price }}</p>
